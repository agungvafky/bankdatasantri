        ...
        <div class="container-fluid">
            <?php $this->load->view("admin/partial/breadcrumb.php") ?>
             <div class="block-header">
                <h3>Settings User</h3>
                Pada Halaman ini anda mengolah data user yaitu admin dan super admin/wali kelas(Simpan, Edit, dan Hapus data)
            </div>
            <?php if ($this->session->flashdata('success')): ?>
                ...
                <script>
                    swal(
                        'Good Job!', 'Data gagal disimpan', 'success');
                </script>
                <?php endif; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <p align="Left"><button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#aduser" ><i class="material-icons">person_add</i><span class="icon-name">User_add</span></button></p>
                            <center>
                             <h2>
                            Users
                            </h2>
                                        ...
                                        <td width="250">
                                            ...
                                            <a onclick="deleteConfirm('<?php echo site_url('admin/santri/deleteu/'.$no->no) ?>')"
                                             href="#!" class="btn btn-danger waves-effect">
                                                 <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span>
                                             </a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
