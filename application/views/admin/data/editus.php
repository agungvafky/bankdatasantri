            ...
            <form action="" method="post" enctype="multipart/form-data" >
                ...
                <label class="form-label">Nama</label>
                    <div class="form-line">
                      ...
                      <input type="hidden" name="pas" value="<?php echo $use->pass ?>" />
                    

               
                      <input type="hidden" class="form-control" name="level" value="<?php echo $use->level ?>"  required>
                  

                
                      <input type="hidden" class="form-control" name="idkelas" value="<?php echo $use->idkelas ?>"  required>
...
<div class="container-fluid">
             ...
             <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="body">
         <form action="<?php echo site_url('admin/santri/passwou') ?>" method="post" enctype="multipart/form-data">
