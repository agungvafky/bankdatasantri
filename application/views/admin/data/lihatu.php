                 ...
                 <div class="col-xs-12 col-sm-3">
                    <div class="card profile-card">
                        ...
                        <div class="profile-footer">
                            ...
                            <a href="<?php echo site_url('admin/santri/edit/'.$santri->nobp) ?>" class="btn btn-primary btn-lg waves-effect btn-block"><i class="material-icons">edit</i> <span class="icon-name">Edit</span></a>
                        </div>
                    </div>
                </div>
