                 ...
                 <div class="col-xs-12 col-sm-3">
                    <div class="card profile-card">
                        ...
                        <div class="profile-footer">
                            ...
                            <a href="<?php echo site_url('admin/santri/editw/'.$santri->nobp) ?>" class="btn btn-primary btn-lg waves-effect btn-block"><i class="material-icons">edit</i> <span class="icon-name">Edit</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="card">
                        <div class="header">
                            ...
                            <a href="<?php echo site_url('admin/santri/lihatk2/'.$this->session->userdata('ses_idkelas')) ?>" class="btn btn-default waves-effect">
