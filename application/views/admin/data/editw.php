            ...
            <?php if ($this->session->flashdata('success')): ?>
             ...
             <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                    <div class="header">
                        <a href="<?php echo site_url('admin/santri/lihatw/'.$santri->nobp) ?>" class="btn btn-default waves-effect">
            ...
            <form action=" " method="post" enctype="multipart/form-data" >
                ...
                <label class="form-label">Tanggal Lahir</label>
                    <div class="form-line">
                      ...
                      <input type="hidden" class="form-control" name="kelas" value="<?php echo $santri->kelas ?>"  >
