                    ...
                    <div class="card">
                        <div class="header">
                            <div class="card-header">
                                <a href="<?php echo site_url('admin/santri/kelas') ?>" class="btn btn-default waves-effect">
                                <i class="material-icons">backspace</i> <span class="icon-name">Kembali</span>
                                </a>
                                <a href="<?php echo site_url('admin/santri/tambahs/'.$idkls) ?>" class="btn btn-primary waves-effect">
                                <i class="material-icons">person_add</i> <span class="icon-name">Tambah Santri</span></span>
                                </a>
                                <center>
                                <h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td width="250">
                                            <a href="<?php echo site_url('admin/santri/lihatkes/'.$no->nobp) ?>" class="btn btn-success waves-effect">
